...
?>
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                <select class="form-control" name="user_ecole" id="user_ecole">
...
?>
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                <select class="form-control" name="user_lab" id="user_lab">
...
?>
    <table class="form-table">
        <tr>
            ...
            <td>
                <input type="date" value="<?php echo esc_attr(get_user_meta($user->ID, 'birthday', true)); ?>" name="user_birthday" id="user_birthday">
...
?>
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                <input type="text" value="<?php echo esc_attr(get_user_meta($user->ID, 'telephone', true)); ?>" name="user_telephone" id="user_telephone">
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                ...
                <select class="form-control" name="user_sexe" id="user_sexe">
...
?>
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                <input type="text" value="<?php echo esc_attr(get_user_meta($user->ID, 'domicile', true)); ?>" name="user_domicile" id="user_domicile">
...
?>
    ...
    <table class="form-table">
        <tr>
            ...
            <td>
                <input type="text" value="<?php echo esc_attr(get_user_meta($user->ID, 'entreprise', true)); ?>" name="user_entreprise" id="user_entreprise">
